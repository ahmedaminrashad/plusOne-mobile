  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        contentContainerStyle={(!groups || groups.length === 0) && !isLoading ? styles.listEmpty : styles.list}
...
const styles = StyleSheet.create({
  ...
  createBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center' },
  ...
  errorBanner: { backgroundColor: Colors.dangerLight, color: Colors.textOnPrimary, textAlign: 'center', padding: 10, fontSize: 13 },
});
